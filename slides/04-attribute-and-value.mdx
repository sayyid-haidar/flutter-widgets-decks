...
## <a>Attribute</a> & <a>value</a>

---

<CodeSurferLayout>

```html title="Attribute & value" subtitle=""
Attribute = property yang membantu mendefinisikan karakteristik tambahan
...
### Aturan dari <a>Attribute</a> & <a>value</a>

<ol>
    <Appear>
        <li>
            Attribute terpasang di <a>Tag pembuka</a>
        </li>
        <li>
            Attribute sudah di <a>tentukan oleh html</a>
        </li>
        <li>
            value harus di simpan di <a>antara tanda petik</a>
        </li>
        <li>
            Ada Attribute yang sifatnya <a>global</a> dan <a>khusus*</a>
        </li>
    </Appear>
</ol>
...
### Attribute yang akan sering kita pakai
